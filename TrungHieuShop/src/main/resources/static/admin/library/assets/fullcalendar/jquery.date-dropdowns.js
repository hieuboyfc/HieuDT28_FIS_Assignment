...
;(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        populateDefaultDate: function () {
            ...
            this.internals.objectRefs.dayDropdown.val(day).trigger('chosen:updated');
            this.internals.objectRefs.monthDropdown.val(month).trigger('chosen:updated');
            this.internals.objectRefs.yearDropdown.val(year).trigger('chosen:updated');
        ...
        /**
         * Format the selected date based on the submitFormat configs value provided
         *
         * @param day
         * @param month
         * @param year
